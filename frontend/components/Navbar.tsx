...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 glass-premium border-b border-white/15">
            ...
            {userMenuOpen && (
              <div className="absolute right-0 mt-2 w-48 glass-premium border border-white/10 rounded-lg shadow-2xl shadow-blue-500/20 overflow-hidden">
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-3 text-sm text-red-400 hover:bg-red-500/20 hover:text-red-300 transition duration-300 ease-premium border-t border-white/10"
                >
                  Logout
                </button>
              </div>
